...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($this->wantsSpaResponse($request)) {
            return $this->spaJson($request, ['data' => $lims_brand_all]);
        }
    ...
    public function store(Request $request)
    {
        ...
        if (isset($input['ajax']) || $this->wantsSpaResponse($request)) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($this->wantsSpaResponse($request)) {
            return $this->spaJson($request, ['data' => $lims_brand_data]);
        }
    ...
    public function importBrand(Request $request)
    {
        ...
        if ($this->wantsSpaResponse($request)) {
            return $this->spaJson($request, [
                'message' => __('db.Brand imported successfully'),
            ]);
        }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        if ($this->wantsSpaResponse($request)) {
            return $this->spaJson($request, [
                'message' => __('db.Brand deleted successfully!'),
            ]);
        }
