...
CREATE TABLE `currencies` (
  ...
  `name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `symbol` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
/*Table structure for table `pos_sync_exchanges` */

DROP TABLE IF EXISTS `pos_sync_exchanges`;

CREATE TABLE `pos_sync_exchanges` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `sync_status` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `error_message` text COLLATE utf8mb4_unicode_ci,
  `payload` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pos_sync_exchanges_client_uuid_unique` (`client_uuid`),
  KEY `pos_sync_exchanges_device_id_index` (`device_id`),
  KEY `pos_sync_exchanges_exchange_id_index` (`exchange_id`),
  KEY `pos_sync_exchanges_sync_status_index` (`sync_status`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Table structure for table `pos_sync_sales` */

DROP TABLE IF EXISTS `pos_sync_sales`;

CREATE TABLE `pos_sync_sales` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `client_uuid` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `device_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `pos_sync_sales_client_uuid_unique` (`client_uuid`),
  KEY `pos_sync_sales_device_id_index` (`device_id`),
  KEY `pos_sync_sales_sale_id_index` (`sale_id`),
  KEY `pos_sync_sales_sync_status_index` (`sync_status`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_adjustments` (
  ...
  `product_id` int NOT NULL,
  `variant_id` int DEFAULT NULL,
  `product_batch_id` int unsigned DEFAULT NULL,
...
CREATE TABLE `product_purchases` (
  ...
  `discount_type` enum('flat','percentage') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'flat',
  `tax_rate` double NOT NULL,
  `tax` double NOT NULL,
  `total` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `qr_codes` (
  ...
  `qrable_type` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sale_exchanges` (
  ...
  UNIQUE KEY `sale_exchanges_client_uuid_unique` (`client_uuid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `terminals` (
  ...
  `activation_token` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `client_token` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pos_token` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pos_token_issued_at` timestamp NULL DEFAULT NULL,
  `warehouse_id` bigint unsigned DEFAULT NULL,
  `device_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  UNIQUE KEY `terminals_activation_token_unique` (`activation_token`),
  UNIQUE KEY `terminals_pos_token_unique` (`pos_token`),
  KEY `terminals_device_id_index` (`device_id`),
  KEY `terminals_is_delete_index` (`is_delete`)
