...
const EditAdjustment = ({ adjustmentId }) => {
  ...
  // Fetch adjustment data on mount
  useEffect(() => {
    if (adjustmentId) {
  ...
  const fetchAdjustment = async (id) => {
    try {
      ...
      alert('Failed to fetch adjustment');
    }
  };
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: 'qty',
        header: 'Existing Adjustment Quantity',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.put(`adjustments/${adjustmentId}`).values(formData);
  ...
  if (!adjustment) {
    return <div className="alert alert-info">Loading adjustment data...</div>;
  }
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <div className="form-group">
                        ...
                        <p>
                          <strong>{adjustment.reference_no}</strong>
                        </p>
                      </div>
                    </div>
                    <div className="col-md-4">
