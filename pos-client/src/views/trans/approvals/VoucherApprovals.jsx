...
const VoucherApprovals = ({showApprovalModal}) => {
  /* --- State declarationss --- */
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await api.get(`pending-voucher-approvals`);
              ...
              return ( 
                <tr key={entity.id}>
                  ...
                  <td className="text-center">
                    <Link to={`/payment-voucher/${entity.nno}/${entity.bc}`} onClick={() => showApprovalModal()}>
