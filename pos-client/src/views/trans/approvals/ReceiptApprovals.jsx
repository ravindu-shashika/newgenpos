...
const ReceiptApprovals = ({showApprovalModal}) => {
  /* --- State declarationss --- */
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await api.get(`pending-receipt-approvals`);
              ...
              return ( 
                <tr key={entity.id}>
                  ...
                  <td className="text-center">
                    <Link to={`/receipt/${entity.nno}/${entity.bc}`} onClick={() => showApprovalModal()}>
