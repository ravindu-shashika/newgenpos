      ...
      setTransactions([
        {
          ...
          cancelPartpayments: cancelPartPayments,
        },
      ]);
        ...
        <div className="container">
          ...
          <div>
            <table className="table table-bordered">
              ...
              <tbody>
                {transactions[0].cancelRedeems
                  ? transactions[0].cancelRedeems.map((row, index) => {
                      return (
                        <tr key={row.id}>
                          {index === 0 ? (
                            <td
                              rowSpan={transactions[0].cancelRedeems.length}
                ...
                {transactions[0].redeemTrans
                  ...
                  : null}
                {transactions[0].cancelPartpayments
                  ? transactions[0].cancelPartpayments.map((row, index) => {
                      return (
                        <tr key={row.id}>
                          {index === 0 ? (
                            <td
                              rowSpan={
                                transactions[0].cancelPartpayments.length
                              }
                              className="text-center"
                              style={{ verticalAlign: 'middle' }}
                            >
                              Cancelled Part-payments
                            </td>
                          ) : null}
                          <td>{row.ddate}</td>
                          <td>{row.trans_type.description}</td>
