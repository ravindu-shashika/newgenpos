                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__('db.System Logo For Dark Mode')}} * <x-info title="jpg, jpeg, png & gif" type="info" /></label>
                                        <input type="file" name="dark_logo" class="form-control" value="" accept="image/png, image/jpeg, image/gif"/>
                                    </div>
                                    @if($errors->has('dark_logo'))
                                   <span>
                                       <strong id="logo_error">{{ $errors->first('dark_logo') }}</strong>
                                    </span>
                                    @endif
                                </div>
                                <div class="col-md-4">
                                ...
                                @if (in_array('api',explode(',',$general_setting->modules)))
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{__('db.Onesignal API Key')}}*</label>
                                            <input class="form-control" name="onesignal_api_key" value="@if($lims_general_setting_data){{$lims_general_setting_data->onesignal_api_key}}@endif" max="6" min="0">
                                        </div>
                                    </div>
                                @endif
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 mt-4 {{ $lims_general_setting_data->maintenance_allowed_ips ? '' : 'd-none' }}">
                                    <div class="form-group mt-2">
                                        <label>{{__('db.maintenance_allowed_ips')}}</label>
