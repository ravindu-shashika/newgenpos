        ...
        <table id="supplier-table" class="table">
            ...
            <tbody>
                ...
                <?php
                    ...
                    $total_purchases = 0;
                    $total_returns = 0;
                    $purchaseData = App\Models\Purchase::select('id', 'grand_total')->where('supplier_id', $supplier->id)->whereNull('deleted_at')->get();
                    foreach ($purchaseData as $purchase) {
                        $total_purchases += $purchase->grand_total;
                        $total_paid += App\Models\Payment::where('purchase_id', $purchase->id)->sum('amount');
                    }
