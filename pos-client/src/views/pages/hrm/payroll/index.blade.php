                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="filterMonth" class="form-control month-picker" required />
                            </div>

                            <script>
                                flatpickr(".month-picker", {
                                    // Ajker date ke default hisebe nebe
                                    defaultDate: "today",

                                    plugins: [
                                        new monthSelectPlugin({
                                            shorthand: true,
                                            dateFormat: "Y-m", // Backend-e jabe (Ex: 2024-05)
                                            altFormat: "F Y" // User dekhbe (Ex: May 2024)
                                        })
                                    ]
                                });
                            </script>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div class="form-group">
                                    <label>Select Month:</label>
                                    <input type="text" name="month" class="form-control month-picker" required />
                                </div>
