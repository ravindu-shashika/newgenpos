                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Alt Product Code *</strong> </label>
                                        <div class="input-group">
                                            <input type="text" name="alt_code" value="{{$lims_product_data->alt_code}}" class="form-control" id="alt_code" aria-describedby="alt_code" required>
                                            <div class="input-group-append">
                                                <button id="genbutton" type="button" class="btn btn-sm btn-default" title="{{__('db.Generate')}}"><i class="fa fa-refresh"></i></button>
                                            </div>
                                        </div>
                                        <span class="validation-msg" id="alt_code-error"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
