...
const SalesReturnNote = {
  async load(trans_id, bc_no, is_dupplicate) {
    let trans_url = 'sales-returns/get-details';
    let url_parameter = { trans_id, bc_no };
  ...
  printPDF(is_dupplicate) {
    ...
    doc.text(""+this.print_data.invoice_id, 38, y);
    y += 4;
