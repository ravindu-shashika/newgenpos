...
export const MENU_PATH_ALIASES = {
  ...
  '/add-adjustment': '/qty_adjustment',
  '/product/add-adjustment': '/qty_adjustment',
  '/qty_adjustment/create': '/qty_adjustment',
...
export const ROUTE_REGISTRY = {
  ...
  '/setting/mail_setting': PlaceholderPage,
  '/setting/payment-gateways/list': PlaceholderPage,
  '/sales/sale_by_csv': PlaceholderPage,
  '/sale/import-csv': PlaceholderPage,
  '/installment-plans/:id': PlaceholderPage,
  '/installmentplan/:id': PlaceholderPage,
