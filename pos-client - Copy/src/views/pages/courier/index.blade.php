        ...
        <table id="courier-table" class="table" style="width: 100%">
            ...
            <tbody>
                ...
                <tr data-id="{{$courier->id}}">
                    ...
                    <td>{{ Str::limit($courier->api_key, 3) }}</td>
                    <td>{{ Str::limit($courier->secret_key, 3) }}</td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" 
                                    ...
                                    data-api_key="{{$courier->api_key}}"
                                    data-secret_key="{{$courier->secret_key}}"
                                     class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{__('db.edit')}}</button></li>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        if ($(this).data('name') == 'SteadFast') {
            $("#editModal input[name='name']").attr('disabled', true);
        } else {
            $("#editModal input[name='name']").removeAttr('disabled');
        }
        $("#editModal input[name='phone_number']").val($(this).data('phone_number'));
        $("#editModal input[name='address']").val($(this).data('address'));
        $("#editModal input[name='api_key']").val($(this).data('api_key'));
        $("#editModal input[name='secret_key']").val($(this).data('secret_key'));
    });
