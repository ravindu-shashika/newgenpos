                                                ...
                                                <table id="myTable" class="table table-hover order-list">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr data-imagedata="{{$preLoadedproduct[3]}}" data-price="{{$preLoadedproduct[2]}}" data-promo-price="{{$preLoadedproduct[4]}}" data-currency="{{$preLoadedproduct[5]}}" data-currency-position="{{$preLoadedproduct[6]}}">
                                                            ...
                                                            <td class="product-alt-code">{{$preLoadedproduct[16]}}</td>
                                                            ...
                                                            <td><input type="hidden" name="products[{{$key}}][alt_code]" value="{{$preLoadedproduct[16]}}"></td>
        ...
        select: function(event, ui) {
            ...
            $.ajax({
                ...
                if(flag){
                    ...
                    cols += '<td class="product-alt-code">' + data[16] + '</td>';
                    ...
                    cols += '<td><input type="hidden" name="products['+ key +'][alt_code]" value="'+data[16]+'"></td>';
