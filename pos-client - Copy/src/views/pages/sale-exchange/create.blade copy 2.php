                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open([
                                'route' => ['exchange.store', $lims_sale_data->id],
                                'method' => 'Post',
                                'files' => true,
                                'id' => 'payment-form',
                            ]) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="reference_no"
                                                    value="{{ $lims_sale_data->reference_no }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            ...
                                            <div class="search-box form-group mb-2" style="position:relative">
                                                <div class="input-group pos">
                                                    <input style="border: 1px solid #7c5cc4;" type="text"
                                                        ...
                                                        class="form-control" />
                                                    <button type="button" class="btn btn-primary" onclick="barcodeSale()">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="table-responsive mt-3">
                                                        <table id="returnable" class="table table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>{{ __('db.name') }}</th>
                                                                    <th>{{ __('db.Code') }}</th>
                                                                    ...
                                                                    <th>{{ __('db.Exchange') }} <x-info
                                                                            title="Check to mark as return product" /></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach ($lims_product_sale_data as $key => $product_sale)
                                                                    <tr>
                                                                        ...
                                                                        <td class="is-exchange text-center">
                                                                            <input type="checkbox" name="is_exchange[]"
                                                                                class="exchange-checkbox"
                                                                                value="{{ $product_data->code }}"
                                                                                data-row-index="{{ $key }}"
                                                                                onchange="handleProductReturn(this)">
                                                                        </td>
                                                                        ...
                                                                        <!-- NEW: Product Type Tracking -->
                                                                        <input type="hidden" class="product-type"
                                                                            name="product_type[]" value="new" />
                                                                        <input type="hidden" class="is-old-product"
                                                                            name="is_old_product[]" value="0" />
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div class="search-box form-group mb-2" style="position:relative">
                                                <div class="input-group pos">
                                                    <input style="border: 1px solid #7c5cc4;" type="text"
                                                        ...
                                                        placeholder="Scan/Search product by name/code/IMEI"
                                                        class="form-control" />
                                                    <button type="button" class="btn btn-primary" onclick="barcodeNew()">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor" class="bi bi-upc"
                                                            viewBox="0 0 16 16">
                                                            <path
...
@push('scripts')
    ...
    <script>
        ...
        // Define separate variables for each search input and its results
        ...
        $(document).ready(function() {
            ...
            function searchProducts(search, type = 'new') {
                // Select the correct results container based on type
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            if (data.length === 1) {
                                if (click === 0) {
                                    if (type == 'return') {
                                        $('#sale_product-results-container .product-img').first().trigger('click');
                                    } else {
            ...
            // ===== NEW PRODUCT INPUT (Default/New Type) =====
            ...
            // ===== SALE PRODUCT INPUT (Return Type) =====
    ...
    <script>
        ...
        let currentScannerType = 'new'; // Track which input is being scanned
    ...
    <script type="text/javascript">
        ...
        // ===== EXCHANGE CALCULATION VARIABLES =====
        var exchangeValue = 0;
        ...
        function calculateExchangeValue() {
            ...
            $('input.exchange-checkbox:checked').each(function() {
                ...
                var subtotal = parseFloat(row.find('.sub-total').text());
                exchangeValue += subtotal;
            });

            console.log('Exchange Value: ' + exchangeValue.toFixed(decimal));
        ...
        function calculateNewProductsTotal() {
            ...
            $('table.order-list tbody tr').each(function() {
                var subtotal = parseFloat($(this).find('.sub-total').text()) || 0;
                newProductsTotal += subtotal;
            });

            console.log('New Products Total: ' + newProductsTotal.toFixed(decimal));
        ...
        function calculateExchangeBalance() {
            ...
            console.log('Exchange Value: ' + exchangeValue.toFixed(decimal));
            console.log('New Products Total: ' + newProductsTotal.toFixed(decimal));
            console.log('Shipping Cost: ' + shippingCost.toFixed(decimal));
            console.log('Grand Total: ' + grandTotal.toFixed(decimal));
            console.log('Balance: ' + balance.toFixed(decimal));
            console.log('============================');
            ...
            // Update balance display with color indication
        ...
        //Change quantity
        $("#myTable, #returnable").on('focusout', '.qty', function() {
            ...
            // Check if this is from returnable table
            let isReturnableTable = $input.closest('#returnable').length > 0;
            let productType = isReturnableTable ? 'return' : 'new';
            ...
            if (is_variant[rowindex]) {
                checkQuantity(value, true, productType);
            } else {
                checkDiscount(value, 'input', productType);
            }
        });
        ...
        $(document).on('click', '.product-img', function() {
            var data = $(this).data();
            var productType = data.type || 'new'; // Get type from data attribute
            productSearch(data, productType);
        });

        function productSearch(data, productType = 'new') {
            if (data.embedded == 1) {
            ...
            // Determine which table to check based on productType
            var tableSelector = productType === 'return' ? '#returnable tbody' : 'table.order-list tbody';

            $(tableSelector + " .product-code").each(function(i) {
                if ($(this).val().trim() == item_code) {
                    rowindex = i;
                    if (data.imei != 'null' && data.imei != '') {
                        var imeiNumbers = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .imei-number').val();
                    ...
                    pre_qty = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .qty').val();
                }
            });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (pre_qty > 0 && data[21]) {
                            var old_batch = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.batch-no').val();
                        ...
                        if (pre_qty > 0) {
                            var qty = data[15];
                            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .qty').val(qty);
                        ...
                        if (flag) {
                            addNewProduct(data, productType);
                        } else if (data[18] != 'null' && data[18] != '') {
                            var imeiNumbers = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.imei-number').val();
                            if (imeiNumbers)
                                imeiNumbers += ',' + data[18];
                            else
                                imeiNumbers = data[18];
                            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.imei-number').val(imeiNumbers);
                        }
                    }
                });
            }
        ...
        function addNewProduct(data, productType = 'new') {
            ...
            if (authUser > 2) {
                cols += '<td class="product-title"><strong>' + data[0] + '<br><span>' + data[1] + '</span>' + stockDisplay +
                ...
                // Different edit buttons for different tables
                if (productType === 'return') {
                    ...
                    cols +=
                        ...
                        data[0] + ' <i class="dripicons-document-edit"></i></strong><br><span>' + data[1] + '</span>' +
                        stockDisplay + ' <strong class="product-price d-md-none"></strong>';
                }
            }
            ...
            // Batch No column (for returnable table)
            if (productType === 'return') {
                if (data[12]) {
                    cols += '<td>' + (data[22] || 'N/A') + '</td>';
                } else {
                    cols += '<td>N/A</td>';
                }
            }
            ...
            // If no IMEI, show minus button (only for new products table)
            if ((!data[18] || data[18] == 'null') && productType === 'new') {
                cols +=
            ...
            // Input field
            cols +=
                '<input type="text" name="qty[]" class="form-control qty numkey input-number" style="font-size:13px;max-width:50px;padding: 0 0;text-align:center" step="any" value="' +
                data[15] + '" max="' + data[19] + '" required><span class="input-group-btn">';

            // If no IMEI, show plus button (only for new products table)
            if ((!data[18] || data[18] == 'null') && productType === 'new') {
                cols +=
            ...
            // Add exchange checkbox for returnable table
            if (productType === 'return') {
                cols += '<td class="is-exchange text-center">';
                cols += '<input type="checkbox" name="is_exchange[]" class="exchange-checkbox" value="' + data[1] + '" onchange="calculateExchangeValue()">';
                cols += '</td>';
            } else {
                // Always show delete button for new products table
                cols +=
            ...
            cols += '<input type="hidden" name="type[]" value="' + productType + '">';
            ...
            // Append to the correct table based on productType
            if (productType === 'return') {
                $("#returnable tbody").append(newRow);
            } else {
            ...
            // Set product price based on table type
            if (productType === 'return') {
                $('#returnable tbody tr:nth-child(' + (rowindex + 1) + ')').find('.product_price').val(product_price[rowindex]);
            } else {
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.product_price').val(product_price[rowindex]);
            }

            checkQuantity(data[15], true, productType);
            checkDiscount(data[15], true, productType);

            if (data[16] && productType === 'new') {
                populatePriceOption();
                $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.edit-product').click();
            }

            // Recalculate based on table type
            if (productType === 'return') {
                calculateExchangeValue();
            } else {
                calculateTotal();
        ...
        function checkDiscount(qty, flag, productType = 'new', price = 0) {
            var customer_id = $('#customer_id').val();
            var warehouse_id = $('#warehouse_id').val();

            var tableSelector = productType === 'return' ? '#returnable tbody' : 'table.order-list tbody';
            var product_id = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .product-id').val();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (product_price[rowindex].length == 0) {
                        product_price[rowindex] = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) +
                            ') .product_price').val();
                    }
            ...
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .qty').val(qty);
            flag = true;
            checkQuantity(String(qty), flag, productType);
        }

        function checkQuantity(sale_qty, flag, productType = 'new') {
            var tableSelector = productType === 'return' ? '#returnable tbody' : 'table.order-list tbody';
            var row_product_code = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.product-code').val();
            var qty = parseFloat($(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.qty').attr('max'));
            var product_type = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.product_type').val();
                ...
                if (product_type.trim() == 'standard' || product_type.trim() == 'combo') {
                    ...
                    if (total_qty > qty) {
                        ...
                        if (imeiNumbers && imeiNumbers.length) {
                            // Allow if IMEI exists
                        } else {
                            alert('Quantity exceeds stock quantity!');

                            if (flag) {
                                sale_qty = (sale_qty - 1);
                                checkQuantity(sale_qty, true, productType);
                            } else {
                                if (productType === 'new') {
                                    edit();
                                }
                        ...
                        if (sale_qty == 0) {
                            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').remove();
                        }
                    }
                    $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.qty').val(sale_qty);
                }
            } else {
                $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.qty').val(sale_qty);
            }
            ...
            calculateRowProductData(sale_qty, productType);
        }
        ...
        function calculateRowProductData(quantity, productType = 'new') {
            if (product_discount[rowindex] < 1) {
                var tableSelector = productType === 'return' ? '#returnable tbody' : 'table.order-list tbody';
                cur_product_id = $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ') .product-id').val();
                @if (isset($draft_product_discount))
                    if (product_discount[rowindex] < 1) {
                        draft_discounts = @json($draft_product_discount['discount']);
                        product_discount[rowindex] = draft_discounts[cur_product_id];
            ...
            var tableSelector = productType === 'return' ? '#returnable tbody' : 'table.order-list tbody';
            var topping_price = ($(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.topping-price')
                .val() * quantity) || 0;

            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.discount-value').val((product_discount[
                rowindex] * quantity).toFixed({{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.tax-rate').val(tax_rate[rowindex]
                .toFixed({{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.net_unit_price').val(net_unit_price
                .toFixed({{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.tax-value').val(tax.toFixed(
                {{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.product-price').text(sub_total_unit
                .toFixed({{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.sub-total').text((sub_total +
                topping_price).toFixed({{ $general_setting->decimal }}));
            $(tableSelector + ' tr:nth-child(' + (rowindex + 1) + ')').find('.subtotal-value').val((sub_total +
                topping_price).toFixed({{ $general_setting->decimal }}));
