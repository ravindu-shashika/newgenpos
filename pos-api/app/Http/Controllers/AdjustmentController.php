...
class AdjustmentController extends Controller
{
    public function index()
    {
        ...
        if( $role->hasPermissionTo('adjustments.view') ) {
            ...
            return response()->json(['data' => $lims_adjustment_all, 'products_without_variant' => $lims_product_list_without_variant, 'products_with_variant' => $lims_product_list_with_variant]);
        }
        else
            return response()->json(['error' => 'db.Sorry! You are not allowed to access this module!'], 403);
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            DB::commit();
            return response()->json(['message' => __('db.Data inserted successfully')]);
        }catch(\Throwable $e){
            DB::rollBack();
