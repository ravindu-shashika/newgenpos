...
class SaleController extends Controller
{
    ...
    {
        $query = Product::leftJoin('product_warehouse', 'products.id', '=', 'product_warehouse.product_id')->where('products.is_active', true);
    ...
    public function search($warehouse_id, $search)
    {
        ...
        if ($byCode->isEmpty() && $byName->isEmpty()) {
            ...
            $byIMEI = ProductWarehouse::where('warehouse_id',$warehouse_id)
        ...
        if ($byCode->isEmpty() && $byName->isEmpty()) {
            ...
            $imeiMatch = ProductWarehouse::where('warehouse_id',$warehouse_id)
                ->where('imei_number','like','%'.$search.'%')
                ->first();
