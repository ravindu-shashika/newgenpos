# KOOBIYA POS — cross-platform desktop installers

Packages the Flutter **pos_app** terminal for Windows, macOS, and Linux.

| Platform | Tool | Output |
|----------|------|--------|
| Windows | Inno Setup 6 | `installer/output/KOOBIYA-POS-Setup-{version}.exe` |
| macOS | `hdiutil` | `installer/output/KOOBIYA-POS-{version}-macos.dmg` |
| Linux | `dpkg-deb` | `installer/output/koobiya-pos_{version}_amd64.deb` |
...
- Internal executable name remains `pos_app.exe` / `pos_app`; display name is **KOOBIYA POS**.
