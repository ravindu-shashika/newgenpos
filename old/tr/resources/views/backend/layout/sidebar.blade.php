                                    ...
                                    <ul id="manufacturing" class="collapse list-unstyled">
                                        ...
                                        @can('production-view')
                                            <li id="production-list-menu">
                                                <a class="{{ request()->is('manufacturing/productions') ? 'active' : '' }}" href="{{ route('productions.index') }}">
                                        ...
                                        @can('production-add')
                                            <li id="production-create-menu">
                                                <a class="{{ request()->is('manufacturing/productions/create') ? 'active' : '' }}" href="{{ route('productions.create') }}">
                                        ...
                                        @can('recipe-view')
                                            <li id="recipe-list-menu">
                                                <a class="{{ request()->is('manufacturing/recipes') ? 'active' : '' }}" href="{{ route('recipes.index') }}">
                                                    {{ __('db.Recipe') }}
                                                </a>
                                            </li>
                                        @endcan
