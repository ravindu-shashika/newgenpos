                        ...
                        @if (isset($show->show_description) && $show->show_description == 1 )
                            <tr style="border-top: 1px dotted #999">
                                ...
                                <td style="text-align:right;vertical-align:bottom">
                                    <x-amount-currency-symbol
                                        :amount="$subtotal"
                                        :currency_symbol="$lims_sale_data->currency->symbol ?? $lims_sale_data->currency->code" /></td>
                            </tr>
                        @endif
                    @endforeach
                    ...
                    @if ($totalDue && isset($show->hide_total_due))
                        <tr>
                            ...
                            <th style="text-align:right">
                                <x-amount-currency-symbol
                                    :amount="$totalDue"
                                    :currency_symbol="$lims_sale_data->currency->symbol ?? $lims_sale_data->currency->code" /></th>
                            @endif
                        </tr>
                    @endif
                    <tr>
